...
const char* classStr[] = { "Mage", "Rogue", "Cleric" };
...
void InputHandler()
{
	while (isRunning)
	{
		...
		else if (g_networkState == NS_Class_Select)
		{
			char userInput[255];
			std::cout << "------------------------------------------------------------" << std::endl;
			std::cout << "Choose your class! (Enter the corresponding #)" << std::endl;
			std::cout << "Choices: 1-Mage | 2-Rogue | 3-Cleric" << std::endl;
			std::cin >> userInput;
		...
		else if (g_networkState == NS_Turn)
		{
			...
			{
				std::cout << "Who do you want to attack? Type target player's name." << std::endl;
				std::cin >> userInput;
			...
			{
				std::cout << "Who do you want to heal? Type target player's name." << std::endl;
				std::cin >> userInput;
